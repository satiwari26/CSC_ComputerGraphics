...
int main(int argc, char **argv)
{
	...
	image->setPixel(V1x, V1y, v1.r,v1.g,v1.b);
	image->setPixel(V2x, V2y, v2.r,v2.g,v2.b);
	image->setPixel(V3x, V3y, v3.r,v3.g,v3.b);
	...
	for(int y = minY; y <= maxY; ++y) {
		for(int x = minX; x <= maxX; ++x) {
			...
			if(alpha > 0 && alpha < 1 && gamma > 0 && gamma < 1 && beta > 0 && beta < 1) {
